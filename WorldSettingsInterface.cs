...
{
    public class WorldSettingsInterface
    {
        ...
        public static bool Draw()
        {
            if (!Active)
            {
                ...
                {
                    Vector2 WorldSettingButtonPosition = new Vector2(2, 2);

                    Main.spriteBatch.Draw(nservermod.worldsettingbuttontexture, WorldSettingButtonPosition, Color.White);
                    if(Main.mouseX >= WorldSettingButtonPosition.X && Main.mouseX < WorldSettingButtonPosition.X + 28 &&
                        Main.mouseY >= WorldSettingButtonPosition.Y && Main.mouseY < WorldSettingButtonPosition.Y + 28)
                    {
            ...
            Main.spriteBatch.Draw(Main.blackTileTexture, new Rectangle((int)StartPosition.X - 2, (int)StartPosition.Y - 2, (int)OptionTextWidth * 2 + 4, 30 * 10 + 4), Color.Black);
            Main.spriteBatch.Draw(Main.blackTileTexture, new Rectangle((int)StartPosition.X, (int)StartPosition.Y, (int)OptionTextWidth * 2, 30 * 10), Color.White);
            {
